<!--Content start-->
         <div class="wrapper">
            ...
            <div class="row">
				...
				<a href="javascript:void(0)" id="search_load_more" onclick="get_more_search_items()" style="display:none;" class="btn btn-load-more"><?php echo get_languageword('load_more');?></a>
				
				<input type="hidden" id="total_search_items" value="<?php if(isset($total_items)) echo $total_items; ?>">	
