<!--Content start-->
         <div class="wrapper">
            ...
            <div class="section">
               ...
               <div class="category-title mb-2"><?php echo get_languageword('popular_items');?></div>
            ...
            <div class="row">
				...
				<a href="javascript:void(0)" id="popular_load_more" onclick="get_more_popular_items()" style="display:none;" class="btn btn-load-more"><?php echo get_languageword('load_more');?></a>
				
				<input type="hidden" id="total_popular_items" value="<?php if(isset($total_items)) echo $total_items; ?>">	
				<input type="hidden" id="popular_items_offset" value="<?php if(isset($offset)) echo $offset; ?>">
			 ...
			 echo '<h4>'.get_languageword('no_popular_items_available').' </h4>';
