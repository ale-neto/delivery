<!--Content start-->
         <div class="wrapper">
            ...
            <div class="section">
               ...
               <div class="category-title mb-2"><?php if (isset($menu_name)) echo $menu_name;?></div>
                    ...
                    <div class="cs-card mb-3 cs-product-card">
                        ...
                        <div class="cs-card-content clearfix">
							...
							<div class="pull-left">
								...
								<h4 style="font-size:13px; color: #77798c; font-weight:200;margin-top: 10px;margin-bottom: 15px" title="<?php echo $item->item_description;?>"><?php echo $item->item_description;?></h4>
            ...
            <div class="row">
            	<div class="col-sm-12">
					...
					<a href="javascript:void(0)" id="load_more" onclick="get_more_items('<?php echo $menu_id;?>')" style="display:none;" class="btn btn-load-more"><?php echo get_languageword('load_more');?></a>
					
					<input type="hidden" id="total_items" value="<?php if(isset($total_items)) echo $total_items; ?>">	
					<input type="hidden" id="offset" value="<?php if(isset($offset)) echo $offset; ?>">
