<div class="container pt-8 pb-8">
	...
	<?php echo $this->session->flashdata('message'); ?>
	 <div class="top-bar-info" style='text-align: center; margin-bottom: 4%; display: flex;'>
            <div class="col-sm-6" >
                    <div class="media-body ct-media-bodys">
                    <div class="media-center ct-icon-font">
                        ...
                        <?php $now = new DateTime();
                        	if($this->config->item('site_settings')->from_time < $now->format('H:i')  && $now->format('H:i') <  $this->config->item('site_settings')->to_time) 
                            echo  '<i class="fa fa-circle" aria-hidden="true" style="color: #5FFC16"></i>' . ' Aberto';
                            else {
                            echo  '<i class="fa fa-circle" aria-hidden="true" style="color: #FF1E22" ></i>' . ' Fechado';
                            }
                        ?></h4>
                           
                        <p> 
                        <?php if(isset($this->config->item('site_settings')->from_time)) 
                            echo $this->config->item('site_settings')->from_time;
                        ?> - 
                        <?php if(isset($this->config->item('site_settings')->to_time)) 
                            echo $this->config->item('site_settings')->to_time;
                        ?>
                        </p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="media-body ct-media-bodys">
                    <div class="media-center ct-icon-font">
                        <a href="<?php echo URL_CONTACT_US;?>"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                    </div>
        ...
        <div class="search cs-searchbox mb-2" >
          <div class="search-innerwrapper">
			...
			?>
              ...
              <a href="javascript:void(0);" class="list-group-item <?php echo $clas;?>" onclick="get_menu_items_block('<?php echo $menu->menu_id;?>','<?php echo $menu->menu_name;?>')" id="<?php echo $menu->menu_id;?>"><?php echo $menu->menu_name;?></a>
			...
			<a href="javascript:void(0);" class="list-group-item" onclick="get_popular_items_block()" id="popular_items"><?php echo get_languageword('popular_items');?></a>
