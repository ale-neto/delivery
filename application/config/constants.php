...
/**OWNER ORANGE CSS**/
define('CSS_OWNER_ORANGE',SITEURL.RESOURCES.DS.'owner'.DS.'css'.DS.'orange'.DS);
define('CSS_OWNER_OR_BOOTSTRAP',CSS_OWNER_ORANGE.'bootstrap.css');
define('CSS_OWNER_OR_STYLE',CSS_OWNER_ORANGE.'style.css');
define('CSS_OWNER_OR_FONT_AWESOME',CSS_OWNER_ORANGE.'font-awesome.css');
define('CSS_OWNER_OR_CUSTOM',CSS_OWNER_ORANGE.'custom.css');
define('CSS_OWNER_OR_MORRIS',CSS_OWNER_ORANGE.'morris'.DS.'morris-0.4.3.min.css');
define('CSS_OWNER_OR_BOOTSTRAP_VALIDATOR',CSS_OWNER_ORANGE.'bootstrapValidator.css');

define('CSS_ORANGE_OWNER',CSS_OWNER_ORANGE.'owner-css.css');

/***OWNER JS**/
define('JS_OWNER',SITEURL.RESOURCES.DS.'owner'.DS.'js'.DS);
define('JS_OWNER_JQUERY',JS_OWNER.'jquery.js');
define('JS_OWNER_ANGULAR',JS_OWNER.'angular.min.js');
define('JS_OWNER_BOOTSTRAP',JS_OWNER.'bootstrap.min.js');
define('JS_OWNER_METIMENU',JS_OWNER.'jquery.metisMenu.js');
define('JS_OWNER_MIRROR_RAPHAEL',JS_OWNER.'morris'.DS.'raphael.min.js');
define('JS_OWNER_MIRROR_MIRROR',JS_OWNER.'morris'.DS.'morris.js');
//define('JS_OWNER_CUSTOM',JS_OWNER.'custom.js');
define('JS_OWNER_BOOTSTRAP_VALIDATOR',JS_OWNER.'bootstrapValidator.min.js');
define('JS_OWNER_BOOTSTRAP_MAXLENGTH_MIN',JS_OWNER.'bootstrap-maxlength.min.js');

define('JS_OWNER_SIDEBAR_MENU',JS_OWNER.'sidebar-menu.js');
...
define('ACTIVE_OWNER','owner_dashboard');
...
define('TEMPLATE_OWNER','templates/owner-template');
...
/**OWNER URL CONSTATNS**/
define('URL_OWNER_INDEX', SITEURL.'owner'.DS.'index');
define('URL_OWNER_PROFILE',SITEURL.'owner'.DS.'profile');
define('URL_OWNER_CHANGE_PASSWORD', SITEURL.'owner'.DS.'change-password');
define('URL_OWNER_ORDERS_OVERVIEW', SITEURL.'owner'.DS.'orders-overview');
...
define('PAGE_OWNER_DASHBOARD','dashboard');
...
define('PAGE_OWNER_RROFILE','profile');
