...
<body>
    <div class="main-wrapper">
        <div  class="ct-banner-image primary-navbar" style="background-color: #4c0100">
                    ...
                    <div class="row">
                        <div class="ct-logo">
                            <div class="navbar-header ct-toggle2">
                                <button type="button" style="font-size: 14px; color: #fff" class="navbar-toggle offcanvas-toggle" data-toggle="offcanvas" <?php if (!$this->ion_auth->logged_in()) :
					$login_popup = 'login';
				?>
					<li>
                         ...
                         <div class="ct-navbar">
                           ...
                           <div class="navbar-offcanvas navbar-offcanvas-touch navbar-right" id="ct-bootstrap-offcanvas">
							  ...
							  <?php endif;?>
                                  ...
                                  <li class="hidden-xs">
                                <a class="nav-cart" href="<?php echo URL_CART_INDEX;?>"><span><i class="fa fa-shopping-basket" aria-hidden="true"></i><span id="items_cnt" class="fc-count"><?php echo count($this->cart->contents());?></span></span> </a>
                              </li>
                              </ul>
                            </div>
                           </div>
        ...
        <div class="menu-footer" style="background: red;"></div>
